...
const privacy = () => {
    return (
        <>
            ...
            <section className={`${stylesFonts.newRoman400} ${classes.main}`}>
                <h1 className={classes.title}>Политика в отношении обработки персональных данных</h1>

                <h2 className={classes.subtitle}>1. Общие положения</h2>
                <p className={classes.text}>
                    ...
                    данных,
                    предпринимаемые Агросток (далее — Оператор).
                </p>
                <ul className={classes.list}>
                    ...
                    <li>
                        ...
                        https://shikarnyivid.ru.
                    </li>
                </ul>

                <h2 className={classes.subtitle}>2. Основные понятия, используемые в Политике</h2>
                <ul className={classes.list}>
                    <li>
                    ...
                    <li>
                        ...
                        баз
                        данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://shikarnyivid.ru.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        определяемому Пользователю веб-сайта https://shikarnyivid.ru.
                    </li>
                    <li>
                    ...
                    <li>
                        2.10. Пользователь — любой посетитель веб-сайта https://agrostokkrd.ru.
                    </li>
                    <li>
                ...
                <h2 className={classes.subtitle}>3. Основные права и обязанности Оператора</h2>
                <ul className={classes.list}>
                    <li>
                ...
                <h2 className={classes.subtitle}>4. Основные права и обязанности субъектов персональных данных</h2>
                <ul className={classes.list}>
                    <li>
                ...
                <h2 className={classes.subtitle}>5. Принципы обработки персональных данных</h2>
                <ul className={classes.list}>
                    <li>
                ...
                <h2 className={classes.subtitle}>6. Цели обработки персональных данных</h2>
                <table className={`${stylesFonts.newRoman400} ${classes.table}`}>
                    <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul>
                                ...
                                <li>Договоры, заключаемые между оператором и субъектом персональных данн</li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                ...
                <h2 className={classes.subtitle}>7. Условия обработки персональных данных</h2>
                <ul className={classes.list}>
                    <li>
                ...
                <ul className={classes.list}>
                    ...
                    <li>
                        ...
                        agrostok.dr@mail.ru с пометкой «Актуализация персональных данных».
                    </li>
                    <li>
                        ...
                        agrostok.dr@mail.ru с пометкой «Отзыв согласия на обработку персональных данных».
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        согласия
                        субъектом персональных данных или требование о прекращении обработки персональных данных, а
                        также
                ...
                <h2 className={classes.subtitle}>10. Трансграничная передача персональных данных</h2>
                <ul className={classes.list}>
                    <li>
                        ...
                        намерении
                        осуществлять трансграничную передачу персональных данных (такое уведомление направляется
                        отдельно от
                ...
                <h2 className={classes.subtitle}>11. Конфиденциальность персональных данных</h2>
                <p className={classes.text}>
                ...
                <h2 className={classes.subtitle}>12. Заключительные положения</h2>
                <ul className={classes.list}>
                    <li>
                    ...
                    <li>
                        ...
                        https://shikarnyivid.ru/privacy.
                    </li>
                </ul>

                <h2 className={classes.titleSecond}>Политика использования контента</h2>
                <h2 className={classes.subtitle}>1. Общие положения:</h2>
                <p className={classes.text}>
                    На этой странице мы четко определяем условия использования контента, представленного на нашем сайте.
                    Мы
                    стремимся защитить наши авторские права и обеспечить честное и согласованное использование
                    материалов.
                    Прочитав нашу политику использования контента, вы соглашаетесь с следующими условиями:
                </p>
                <ul className={classes.list}>
                    <li>
                        1.1. Авторские права: Весь контент на данном сайте является объектом авторских прав и
                        принадлежит ИП Егоров Егор Викторович. Перед использованием или распространением любого материала с нашего
                        сайта, необходимо получить письменное разрешение.
                    </li>
                    <li>
                        1.2. Личное использование: Посетители могут свободно просматривать, загружать и распечатывать
                        материалы с
                        нашего сайта для личного, некоммерческого использования.
                    </li>
                    <li>
                        1.3. Несанкционированное использование: Любое несанкционированное копирование, воспроизведение,
                        распространение или изменение нашего контента считается нарушением авторских прав.
                    </li>
                    <li>
                        1.4. Связь с нами: Если у вас есть вопросы относительно использования нашего контента или если
                        вам
                        необходимо разрешение на его использование, пожалуйста, свяжитесь с нами через электронную почту
                        agrostok.dr@mail.ru.
                    </li>
                </ul>
            </section>
